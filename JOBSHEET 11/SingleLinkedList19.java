public class SingleLinkedList19 {
    ...
    void addFirst(Mahasiswa19 input) {
    ...
    void addLast(Mahasiswa19 input) {
        NodeMahasiswa19 ndInput = new NodeMahasiswa19(input, null);
        if (isEmpty()) {
            head = ndInput;
            tail = ndInput;
    ...
    void insertAfter(String key, Mahasiswa19 input) {
        NodeMahasiswa19 ndInput = new NodeMahasiswa19(input, null) ;
        NodeMahasiswa19 temp = head;
        
        do{
            if (temp.data.nm.equalsIgnoreCase(key)) {
    ...
    void insertAt(int index, Mahasiswa19 input) {
        if (index < 0 ) {
